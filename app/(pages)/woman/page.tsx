    ...
    <div>
      ...
      <div className='w-full flex flex-col gap-12'>
        ...
        <div className='flex flex-col gap-8 items-center max-mobile:px-5 mobile:px-10'>
          <p className='text-5xl font-semibold max-laptop:text-4xl max-mobile:text-3xl pt-8 max-mobile:text-center'>WOMEN&#39;S CLOTHING COLLECTION</p>
          <p className='text-[#a9a9a9] text-center max-mobile:text-sm'>Find everything you need to look and feel your best and shop the latest women&#39;s<br className="hidden mobile:block"/>fashion and lifestyle products.</p>
        </div>
